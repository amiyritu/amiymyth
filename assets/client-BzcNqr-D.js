import { r as za, w as Pa } from "./chunk-7R3XDUXW-BHIEIWN9.js";
var xo = { exports: {} },
  ve = {},
  _o = { exports: {} },
  No = {};
...
function Pi(e, n, t, r) {
  ...
  (l !== null
    ...
    (Oa(n, t, l, r) && (t = null),
    r || l === null
      ? Da(n) && (t === null ? e.removeAttribute(n) : e.setAttribute(n, "" + t))
      : l.mustUseProperty
...
var $e = La.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
...
function Ha(e, n, t, r, l, i, u, o, s) {
  ((gt = !1), (Er = null), Aa.apply(Ba, arguments));
}
...
var Yo = me.unstable_scheduleCallback,
  ...
  $a = me.unstable_shouldYield,
  Ka = me.unstable_requestPaint,
  Q = me.unstable_now,
  Ya = me.unstable_getCurrentPriorityLevel,
  Ri = me.unstable_ImmediatePriority,
  Xo = me.unstable_UserBlockingPriority,
  xr = me.unstable_NormalPriority,
  Xa = me.unstable_LowPriority,
...
var Pe = Math.clz32 ? Math.clz32 : qa,
  Za = Math.log,
  Ja = Math.LN2;
function qa(e) {
...
function rc(e, n, t, r, l) {
  switch (n) {
    ...
    case "gotpointercapture":
      return (
        (i = l.pointerId),
        Lt.set(i, ot(Lt.get(i) || null, e, n, t, r, l)),
        !0
      );
  }
  return !1;
...
function st(e, n) {
  e.blockedOn === n &&
    ...
    Jl ||
      ((Jl = !0),
      me.unstable_scheduleCallback(me.unstable_NormalPriority, lc)));
}
function Mt(e) {
  function n(l) {
    return st(l, e);
...
function Ii(e, n, t, r) {
  if (Nr) {
    ...
    else if ((zu(e, r), n & 4 && -1 < tc.indexOf(e))) {
      for (; l !== null; ) {
        var i = $t(l);
        if (
          (i !== null && qo(i),
...
var nt = {
  ...
  Lu = he(Kr),
  sc = V({}, Kr, { dataTransfer: 0 }),
  ac = he(sc),
  cc = V({}, Wt, { relatedTarget: 0 }),
  hl = he(cc),
  fc = V({}, nt, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  dc = he(fc),
  pc = V({}, nt, {
...
var kc = V({}, Wt, {
  ...
  xc = he(Cc),
  _c = V({}, nt, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Nc = he(_c),
  zc = V({}, Kr, {
    deltaX: function (e) {
...
var Le = typeof Object.is == "function" ? Object.is : Ac;
function Rt(e, n) {
  if (Le(e, n)) return !0;
...
var Hc = Be && "documentMode" in document && 11 >= document.documentMode,
  Rn = null,
  bl = null,
  St = null,
  ei = !1;
...
for (var kl = 0; kl < Bu.length; kl++) {
  var Sl = Bu[kl],
    Qc = Sl.toLowerCase(),
    Wc = Sl[0].toUpperCase() + Sl.slice(1);
  cn(Qc, "on" + Wc);
}
...
var ht =
  ...
  $c = new Set("cancel close invalid load scroll toggle".split(" ").concat(ht));
function Hu(e, n, t) {
  ...
  if (!e[rr]) {
    ((e[rr] = !0),
      zo.forEach(function (t) {
        t !== "selectionchange" && ($c.has(t) || El(t, !1, e), El(t, !0, e));
      }));
...
var li = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  Gc =
    typeof queueMicrotask == "function"
      ...
      : typeof $u < "u"
        ? function (e) {
            return $u.resolve(null).then(e).catch(Zc);
          }
        : li;
function Zc(e) {
  setTimeout(function () {
...
var tt = Math.random().toString(36).slice(2),
  ...
  ii = "__reactEvents$" + tt,
  Jc = "__reactListeners$" + tt,
  qc = "__reactHandles$" + tt;
function yn(e) {
  var n = e[Re];
  if (n) return n;
...
var ef = $e.ReactCurrentBatchConfig;
function ct(e, n, t) {
  if (
...
function eu(e, n, t, r, l, i) {
  if (
    ...
    (n.updateQueue = null),
    (n.lanes = 0),
    (vr.current = e === null || e.memoizedState === null ? uf : of),
    (e = t(r, l)),
    Et)
  ) {
    i = 0;
...
function Ds(e, n) {
  ...
  if (
    ...
    if (
      ((t.flags |= 2048),
      Bt(9, Os.bind(null, t, r, l, n), void 0, null),
      G === null)
    )
      throw Error(y(349));
    xn & 30 || Rs(t, n, l);
...
function Os(e, n, t, r) {
  ((n.value = t), (n.getSnapshot = r), Is(n) && js(e));
}
function Fs(e, n, t) {
  return t(function () {
    Is(n) && js(e);
...
function lf(e, n, t) {
  ...
  if (Ys(e)) Xs(n, l);
    ...
    ((t = Ps(e, n, l, r)),
      t !== null && ((l = le()), Te(t, e, r, l), Gs(t, n, r)));
  }
}
function Ys(e) {
  var n = e.alternate;
...
var Vr = {
  ...
  uf = {
    ...
    useImperativeHandle: function (e, n, t) {
      return (
        (t = t != null ? t.concat([e]) : null),
        hr(4194308, 4, Bs.bind(null, n, e), t)
      );
    },
    ...
    useSyncExternalStore: function (e, n, t) {
      ...
      return (
        ...
        (r.flags |= 2048),
        Bt(9, Os.bind(null, r, i, t, n), void 0, null),
        t
      );
    },
    useId: function () {
  ...
  sf = {
    ...
    useDeferredValue: function (e) {
      var n = Ee();
      return $ === null ? (n.memoizedState = e) : $s(n, $.memoizedState, e);
    },
    useTransition: function () {
      var e = Tl(At)[0],
        n = Ee().memoizedState;
...
var cf = $e.ReactCurrentOwner,
  oe = !1;
function re(e, n, t, r) {
  n.child = e === null ? zs(n, null, t, r) : Jn(n, e.child, t, r);
}
...
function so(e, n, t, r, l) {
  if (e === null) {
    ...
    return typeof i == "function" &&
      ...
      ? ((n.tag = 15), (n.type = i), bs(e, n, i, r, l))
...
function ao(e, n, t, r, l) {
  ...
  if ((Kn(n, l), n.stateNode === null))
    (yr(e, n), Zs(n, t, r), fi(n, t, r, l), (r = !0));
  else if (e === null) {
    var u = n.stateNode,
      o = n.memoizedProps;
    u.props = o;
...
function sa(e) {
  ...
  (n !== null && ((e.alternate = null), sa(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Re], delete n[It], delete n[ii], delete n[Jc], delete n[qc])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function ki(e, n, t) {
  ...
  if (r === 5 || r === 6)
    ...
    for (ki(e, n, t), e = e.sibling; e !== null; )
...
var Z = null,
  Ne = !1;
function Ke(e, n, t) {
  for (t = t.child; t !== null; ) (ca(e, n, t), (t = t.sibling));
}
function ca(e, n, t) {
            ...
            ((u = S),
              ...
              u.tag === 22 && u.memoizedState !== null
                ...
                : s !== null
                  ? ((s.return = u), (S = s))
                  : go(l));
        for (; i !== null; ) ((S = i), da(i), (i = i.sibling));
        ((S = l), (sr = o), (ne = d));
      }
      ho(e);
    } else
...
function ce(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Nu(t), n === 1))
      (e.tag === 0 ? bc(wo.bind(null, e)) : Es(wo.bind(null, e)),
        Gc(function () {
          !(L & 6) && dn();
        }),
        (t = null));
...
function pa(e, n) {
  ...
  return (ce(e, Q()), e.callbackNode === t ? pa.bind(null, e) : null);
}
function xi(e, n) {
  var t = xt;
  return (
...
function kn(e, n) {
  ...
  if ((t !== -1 && ((e.timeoutHandle = -1), Xc(t)), W !== null))
...
function hn(e, n, t) {
  var r = M,
    l = ke.transition;
  try {
    ((ke.transition = null), (M = 1), Ef(e, n, t, r));
  } finally {
    ((ke.transition = l), (M = r));
  }
  return null;
...
wa = function (e, n, t) {
  if (e !== null)
    if (e.memoizedProps !== n.pendingProps || se.current) oe = !0;
      ...
      if (!(e.lanes & t) && !(n.flags & 128)) return ((oe = !1), df(e, n, t));
      oe = !!(e.flags & 131072);
    }
...
Bo = su;
Ho = Nn;
var Df = { usingClientEntryPoint: !1, Events: [$t, Fn, Gr, Vo, Ao, su] },
  dt = {
...
if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
  ...
  if (!cr.isDisabled && cr.supportsFiber)
    try {
      (($r = cr.inject(Rf)), (Oe = cr));
    } catch {}
}
ve.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Df;
...
ve.hydrateRoot = function (e, n, t) {
  ...
  if (
    ...
    (n = Ea(n, null, e, 1, t ?? null, l, !1, i, u)),
    (e[He] = n.current),
    Ot(e),
    r)
  )
...
var Of,
  Ff,
  Co = _a;
((Ff = Co.createRoot), (Of = Co.hydrateRoot));
export { jf as R, Ff as c, Of as h, _a as r };
